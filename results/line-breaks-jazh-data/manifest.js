var tests = {
	...
	'CSS3 Text, linebreaks: Conditional Japanese Starter (CJ) (strict,ja)',
	...
	'https://drafts.csswg.org/css-text-3/#line-breaking',
	'[Exploratory] The browser WILL allow a conditional Japanese starter at the beginning of a line.',
	],
	...
	'https://drafts.csswg.org/css-text-3/#line-breaking',
	'When the language is Japanese, and line-break:loose, a browser may allow a break before an inseparable character.',
	],
	'ja/css-text-line-break-ja-cpm-loose.html': [
	'CSS text, linebreaks: centred punctuation (loose,ja)',
	'https://drafts.csswg.org/css-text-3/#line-breaking',
	'When the language is Japanese, and line-break:loose, a browser may allow a break before one of the centred punctuation characters listed.',
	],
	...
	'https://drafts.csswg.org/css-text-3/#line-breaking',
	'When the language is Chinese, and line-break:loose, a browser may allow a break before an inseparable character.',
	],
	'zh/css-text-line-break-zh-cpm-loose.html': [
	'CSS text, linebreaks: centred punctuation (loose,zh)',
	'https://drafts.csswg.org/css-text-3/#line-breaking',
	'When the language is Chinese, and line-break:loose, a browser may allow a break before one of the centred punctuation characters listed.',
	],
